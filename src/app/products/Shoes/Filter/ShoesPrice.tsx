...
export default function FilterPrice({selectedPrices ,setchange}: any) {
  ...
  useEffect(() => {
    const data=ProductsShoes.filter(i=>i.type==selectedPrices)
  ...
  return (
    <div>
      <div className="w-[110px] sm:w-[140px] relative right-[2px] sm:right-[20px] top-[1px] mb-[10px] border border-solid border-black p-2 font-medium">
