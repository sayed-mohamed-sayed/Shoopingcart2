...
export default function FilterPrice({selectedPrices ,setchange}: any) {
  ...
  useEffect(() => {
    const data=locale==="ar"? ProductsClothes:ProductsClothesen.filter(i=>i.type==selectedPrices)
  ...
  return (
    <div>
      <div className="dark:bg-black overflow-hidden dark:text-white dark:border-solid border dark:border-white w-[110px] sm:w-[140px] relative  bg-[whitesmoke] p-2 font-medium">
